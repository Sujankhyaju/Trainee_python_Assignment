...
print("Mean is {} and variance is {}".format(meanCalculation(Numbers),sdCalculation(Numbers)))
print("Using Statistics Module")
print("Mean is {} and standard deviation is {}".format(mean(Numbers),stdev(Numbers)))
